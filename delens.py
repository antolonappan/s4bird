...
delens_lib = Delensing(delens_path,sims,ivfs_raw,qlms_dd,qresp_dd,nhl_dd,n_sims,lmax_qlm,cl_unl['pp'],nside,maskpaths[0],qe_key,transf=transf_of,save_template=True,verbose=False)

pcl_dir = pseudo_cl_config['folder']
pcl_beam = int(pseudo_cl_config['beam'])
...
pseudocl_lib = Pseudo_cl(pcl_path,delens_lib,pcl_maskbase,pcl_beam,pcl_purify_b,pcl_nside,pcl_fsky,pcl_binsize,pcl_apo_scale,pcl_apo_method)
